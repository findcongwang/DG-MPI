...
class mMesh  
{
 ...
 public:
  ...
  Edge*   createEdgeWP      (vector<int>& vertexiD, int geomOrder, gEntity *classif, int elmPartition, vector<int>& elmNeighbours, int elmID);
  Face*   createFaceWithVerticesWP (vector<int>& vertexiD, int theType, int geomOrder, gEntity *classif, int elmPartition, vector<int>& elmNeighbours, int elmID); //generalized
  Face*   createFaceWithVertices (vector<int>& vertexiD, int theType, int geomOrder, gEntity *classif);
  ...
  mTet*   createTetWithVertices (vector<int>& vertexiD, int geomOrder, gEntity *classif);
  mTet*   createTetWithVerticesWP (vector<int>& vertexiD, int geomOrder, gEntity *classif, int elmPartition, vector<int>& elmNeighbours, int elmID); //generalized
